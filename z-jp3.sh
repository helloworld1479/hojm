...
# Config
COMMENT="DJ-日本L3"                                          # DNS Record Comment
CFZONE_NAMES=("iosqq.top" "709900.xyz")                    # Cloudflare DNS Zone Names
CFRECORD_NAMES=("jpsan" "jpl3")                              # Cloudflare DNS Record Names
NODE_ID_1=443                                              # First node_id
NODE_ID_2=444                                              # Second node_id
NODE_ID_3=49                                               # Third node_id
