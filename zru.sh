...
# Config
COMMENT="DJ-俄罗斯L3"                                          # DNS Record Comment
CFZONE_NAMES=("iosqq.top" "709900.xyz")                    # Cloudflare DNS Zone Names
CFRECORD_NAMES=("mz2" "ru")                              # Cloudflare DNS Record Names
NODE_ID_1=395                                              # First node_id
NODE_ID_2=363                                              # Second node_id
NODE_ID_3=73                                               # Third node_id
