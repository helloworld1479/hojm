                            ...
                            <div class="card-inner">
								...
								<nav class="tab-nav margin-top-no">
									<ul class="nav nav-list">
										...
										<li>
											<a class="" data-toggle="tab" href="#info_center"><i class="icon icon-lg">flight_takeoff</i>&nbsp;备用域名</a>
										</li>
									</ul>
								</nav>
									...
									<div class="tab-content">
										<div class="tab-pane fade" id="info_center">
											<div class="tab-pane fade active in" id="sub_center_general">
												<p><span class="icon icon-lg text-white">filter_1</span> [ 备用域名 ]：dongfangmu1.xyz和dongfangmu99.xyz</p>
												</p>
												<hr/>
												<p><span class="icon icon-lg text-white">filter_2</span> [ 加入电报群获取最新域名(需要挂梯) ]：<a class="btn-dl" href="https://t.me/dongfangmussr"><i class="material-icons icon-sm">how_to_vote</i>点击查看</a>
												</p>
											</div>
                                        ...
                                        <div class="tab-pane fade active in" id="sub_center">				
											<div class="tab-pane fade active in" id="sub_center_general">
												<p><span class="icon icon-lg text-white">filter_1</span> [ v2ray4端教程 ]：<a class="btn-dl" href="/user/code"><i class="material-icons icon-sm">how_to_vote</i>点击查看在充值页面下拉</a></p>
												</p>
												<hr/>
												<p><span class="icon icon-lg text-white">filter_2</span> [ VMess ]：
