...
set -o nounset
set -o pipefail
SPECIFIC_IP="119.36.225.156"  # 将这里的IP地址替换为您想要的特定IP安徽241

CFKEY="754562d8862d840a8eb6009745b79fc352610"
CFUSER="6733268@gmail.com"

CFZONE_NAMES=("potatoeswater.com" "dfnode.top" "potatoeswater.com" "dfnode.top" "potatoeswater.com" "dongfanghl.com" "dongfanghl.com" "dongfanghl.com" "dongfanghl.com" "dongfanghl.com")
CFRECORD_NAMES=("downca" "jjm" "download1" "jpcm" "download4" "down9pa" "down3a" "am" "ccu" "download1")
