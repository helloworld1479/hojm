...
# Config
COMMENT="DJ-德国L3"                                          # DNS Record Comment
CFZONE_NAMES=("iosqq.top" "709900.xyz")                    # Cloudflare DNS Zone Names
CFRECORD_NAMES=("de" "de")                              # Cloudflare DNS Record Names
NODE_ID_1=335                                              # First node_id
NODE_ID_2=336                                              # Second node_id
NODE_ID_3=33                                               # Third node_id
