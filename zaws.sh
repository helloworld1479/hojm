...
# Config
COMMENT="DJ-aws租L3"                                          # DNS Record Comment
CFZONE_NAMES=("iosqq.top" "709900.xyz")                    # Cloudflare DNS Zone Names
CFRECORD_NAMES=("bjly" "awsz")                              # Cloudflare DNS Record Names
NODE_ID_1=405                                              # First node_id
NODE_ID_2=406                                              # Second node_id
NODE_ID_3=75                                               # Third node_id
