...
# Config
COMMENT="DJ-美国91-P01-L3"                                          # DNS Record Comment
CFZONE_NAMES=("iosqq.top" "709900.xyz")                    # Cloudflare DNS Zone Names
CFRECORD_NAMES=("us91" "us01")                              # Cloudflare DNS Record Names
NODE_ID_1=392                                              # First node_id
NODE_ID_2=393                                              # Second node_id
NODE_ID_3=21                                               # Third node_id
