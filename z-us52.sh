...
# Config
COMMENT="DJ-美国52"                                          # DNS Record Comment
CFZONE_NAMES=("iosqq.top" "709900.xyz")                    # Cloudflare DNS Zone Names
CFRECORD_NAMES=("us03" "us52")                              # Cloudflare DNS Record Names
NODE_ID_1=324                                              # First node_id
NODE_ID_2=325                                              # Second node_id
NODE_ID_3=747                                               # Third node_id
