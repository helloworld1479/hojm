...
# Config
COMMENT="DJ-台湾动态L3"                                          # DNS Record Comment
CFZONE_NAMES=("iosqq.top" "709900.xyz")                    # Cloudflare DNS Zone Names
CFRECORD_NAMES=("twf" "twdt")                              # Cloudflare DNS Record Names
NODE_ID_1=398                                              # First node_id
NODE_ID_2=293                                              # Second node_id
NODE_ID_3=1                                               # Third node_id
...
function install_docker(){
    ...
    # 配置 Docker 全局日志限制（防止日志撑满硬盘）
    echo "### 配置 Docker 全局日志限制 ###"
...
EOF
    echo "Docker 日志限制已配置：单文件最大 50MB，最多保留 3 个文件"
